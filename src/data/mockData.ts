...
export const INITIAL_FORMULARY: DrugFormularyItem[] = [
  ...
  {
    id: 'flunixin_lowdose',
    name: 'Flunixin Meglumine (Anti-Endotoxemic Low-Dose)',
    brand: 'Banamine (Low-Dose)',
    category: 'Anti-Endotoxemics',
    ...
    indications: ['Endotoxemia / SIRS protection', 'Endotoxin-induced eicosanoid inhibition without masking severe visceral surgical pain'],
    cautions: 'Sub-analgesic dose specifically tailored for anti-endotoxemia in colic/strangulation cases.',
    sourceConfidence: 'verified_today',
    notes: '0.25 mg/kg IV q8h provides anti-endotoxic coverage while avoiding masking of surgical pain escalation.',
  },
  {
    id: 'polymyxin_b',
    name: 'Polymyxin B',
    ...
    category: 'Anti-Endotoxemics',
    defaultDoseRate: 3000,
    maxDoseRate: 6000,
    doseUnit: 'IU/kg',
    defaultConcentration: 500000,
    concentrationUnit: 'IU/vial',
    route: 'IV Infusion',
    defaultFrequency: 'q12h',
    indications: ['Binds Circulating Endotoxin (LPS)', 'Endotoxemia / Gram-negative Sepsis'],
    cautions: 'Nephrotoxic & neurotoxic at antimicrobial doses; use low anti-endotoxic dose (1,000–6,000 IU/kg) diluted in 500 mL IV fluids over 30 mins.',
    sourceConfidence: 'verified_today',
    notes: 'Binds lipid A portion of endotoxin to prevent SIRS cascade in acute strangulating obstructions.',
  },
  {
    id: 'pentoxifylline',
    name: 'Pentoxifylline',
    ...
    route: 'PO, IV',
    defaultFrequency: 'q8h',
    indications: ['Inhibits TNF-alpha & cytokine cascade', 'Improves microvascular RBC deformability in endotoxemic shock'],
    cautions: 'Give with food or via NGT; monitor for mild mild hypokalemia or sweating.',
    sourceConfidence: 'verified_today',
    notes: 'Phosphodiesterase inhibitor reducing systemic inflammatory response in ischemic colic.',
  },

  // --- Shock Resuscitation & Laxatives ---
  {
    id: 'hypertonic_saline',
    name: 'Hypertonic Saline 7.2%',
    brand: 'HyperSal 7.2%',
    category: 'Shock & Laxatives',
    defaultDoseRate: 4.0,
    maxDoseRate: 5.0,
    doseUnit: 'mL/kg',
    ...
    indications: ['Endotoxic / Hypovolemic Shock Resuscitation', 'Rapid Plasma Volume Expansion'],
    cautions: 'MUST follow immediately with large-volume isotonic crystalloid IV fluids (20–40 L) to maintain hydration.',
    sourceConfidence: 'verified_today',
    notes: 'Rapidly draws fluid from intracellular space into intravascular compartment during severe hypovolemia.',
  },
  {
    id: 'mineral_oil',
    ...
    concentrationUnit: '%',
    route: 'PO via NGT',
    defaultFrequency: 'q12h-q24h',
    indications: ['Pelvic Flexure Impaction', 'GI Transit Time Indicator', 'Stool Softener'],
    cautions: 'NEVER administer if nasogastric reflux is present (>2 L). Ensure tube placement in stomach — aspiration pneumonia is fatal.',
    sourceConfidence: 'verified_today',
    notes: '2 to 4 Liters per 500 kg horse via NGT; penetrates and lubricates impactions.',
  },
  {
    ...
    route: 'PO via NGT',
    defaultFrequency: 'q24h',
    indications: ['Osmotic Laxative for Pelvic Flexure Impaction'],
    cautions: 'Ensure adequate systemic hydration before dosing; excessive magnesium absorption can cause sedation or muscle weakness.',
    sourceConfidence: 'verified_today',
    notes: '500g in 4–6 Liters warm water via NGT for osmotic intestinal fluid draw.',
  },
  {
    id: 'psyllium',
    ...
    route: 'PO via NGT',
    defaultFrequency: 'q24h',
    indications: ['Sand Colic Accumulation / Impaction'],
    cautions: 'Mix in warm water and pump via NGT immediately before it forms heavy gel in tube.',
    sourceConfidence: 'verified_today',
    notes: 'Binds heavy intestinal sand and carries it out through colon.',
  },
  {
    id: 'dss',
    name: 'DSS (Docusate Sodium 5%)',
    brand: 'Surfak / Dioctyl Sodium Sulfosuccinate',
    category: 'Shock & Laxatives',
    ...
    concentrationUnit: 'mg/mL',
    route: 'PO via NGT',
    defaultFrequency: 'q48h',
    indications: ['Surfactant / Stool Softener for Refractory Impactions'],
    cautions: 'Overdose or repeat dosing <48h causes severe mucosal dehydration and enteritis.',
    sourceConfidence: 'verified_today',
    notes: 'Lowers surface tension allowing water penetration into hard fecal impactions.',
  },
